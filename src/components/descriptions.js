      ...
      <div className="row">
        <div className="col">
          ...
          <p className="sub-text">
            Mr. Lance is the worst teacher of all time. He has repeatdely proven
            to me that he understands computer science, however his teaching
            skills require some work.
          </p>
        </div>
        <div className="col">
